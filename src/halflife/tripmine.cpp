...
{
	SR_REGISTER( "KL", CTripmineGrenade, BeamBreakThink );
	SR_REGISTER( "KM", CTripmineGrenade, DelayDeathThink );
	SR_REGISTER( "KN", CTripmineGrenade, PowerupThink );
	SR_REGISTER( "KO", CBaseEntity, SUB_Remove );
}
