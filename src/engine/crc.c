...
MD5 Hash function
The md5 hash returns a 16 byte identifier based on the file's data.  This identifier is virtually
  collision free.  I use it to track third party customizations and determine whether I need to
